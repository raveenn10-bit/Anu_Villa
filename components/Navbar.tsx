      ...
      <header
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
          isScrolled
            ...
            : "bg-white/80 backdrop-blur-sm py-4 border-b border-sand-100"
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          {/* Brand Logo */}
          <Link href="#home" className="flex items-center gap-3 group">
            <div className="relative w-12 h-12 rounded-full overflow-hidden bg-white shadow-sm border border-gold-200/60 p-0.5 transition-transform duration-300 group-hover:scale-105">
              <Image
                src="/images/logo.png"
                alt="Anu Villa Logo"
                fill
            ...
            <div className="flex flex-col">
              <span className="font-serif text-xl font-bold tracking-wider text-charcoal-900 leading-none group-hover:text-gold-600 transition-colors">
                ANU VILLA
              </span>
              <span className="text-[10px] tracking-[0.25em] uppercase text-gold-600 font-semibold mt-1">
                Unawatuna • Galle
              </span>
            </div>
          </Link>
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <motion.button
              ...
              className="bg-gold-500 hover:bg-gold-600 text-white px-5 py-2.5 rounded-lg font-medium text-sm shadow-sm transition-all flex items-center gap-2"
            >
            ...
            <motion.button
              ...
              className="w-10 h-10 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white flex items-center justify-center shadow-sm transition-all"
            >
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-4/5 max-w-sm bg-white shadow-2xl z-50 p-6 flex flex-col justify-between sm:hidden"
            >
              <div>
                <div className="flex items-center justify-between pb-6 border-b border-sand-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-serif font-bold text-charcoal-900">ANU VILLA</h4>
                      <p className="text-[10px] text-gold-600 uppercase tracking-widest font-semibold">Unawatuna • Galle</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setMobileMenuOpen(false)}
