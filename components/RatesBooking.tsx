              ...
              <div className="py-6 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-0.5">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full bg-[#003580] hover:bg-[#00224f] text-white py-3 px-3 rounded-2xl font-semibold text-xs shadow-sm transition-all flex items-center justify-center gap-1.5 group"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full bg-[#FF5A5F] hover:bg-[#e0484d] text-white py-3 px-3 rounded-2xl font-semibold text-xs shadow-sm transition-all flex items-center justify-center gap-1.5 group"
                  >
